...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/MarkUp/SCHEMA/xhtml11.xsd" xml:lang="fi">
    <head>
        ...
        <title><fmt:message key="title.service" /> - <fmt:message key="title.users.add" /></title>
    </head>
    <body>
                ...
                <table id="add_user_table">
                    <tr>
                        ...
                        <td class="add_user_table_col2">
                            <form:select path="user.owner" id="user_owner">
                                <form:option value="-1" label="-"/>
                                <form:options items="${owners}" itemValue="id" itemLabel="name"/>
                            </form:select>
                        </td>
                        <td class="add_user_table_col3">* <form:errors path="user.owner" cssClass="error" /></td>
                    </tr>
                    <tr>
                        <td class="add_user_table_col1"><fmt:message key="label.users.addedit.group" /></td>
                        <td class="add_user_table_col2">
                        ...
                        <td class="add_user_table_col3">* <form:errors path="group" cssClass="error" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="add_user_table_col2"><form:input id="add_user_table_username_input" path="user.username" /></td>
                        <td class="add_location_table_col3">* <form:errors path="user.username" cssClass="error" /></td>
                    </tr>
                    <tr>
