...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/MarkUp/SCHEMA/xhtml11.xsd" xml:lang="fi">
    <head>
        ...
        <title><fmt:message key="title.service" /> - <fmt:message key="title.languages.add" /></title>
    </head>
    <body>
        <jsp:include page="main_menu.jsp" />
        <div id="page_title"><fmt:message key="title.languages.add" /></div>
        <div id="main">
            <form:form acceptCharset="UTF-8" method="POST" commandName="language">
                <table id="add_language_table">
                    ...
                    <tr>
                        <td class="add_language_table_col1"><fmt:message key="label.language.addedit.template.create" /></td>
                        <td class="add_language_table_col2"><input type="checkbox" name="templates" value="" checked="yes" /></td>
