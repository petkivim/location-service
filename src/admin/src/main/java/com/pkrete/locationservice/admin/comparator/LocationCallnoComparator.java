...
/**
 * This class implements a comparison function, which imposes an ordering
 * of two Location objects by call number.
 *
...
public class LocationCallnoComparator implements Comparator<Location> {
     ...
     * @returns the value 0 if o1 is equal to o2; value less than 0 if
     * o1 is less than o2 and value greater than 0 if o1 is greater than
     * o2
     */
