 ...
 * methods in this class are static and they can be used for validating
 * user input.
 *
 * @author Petteri Kivimäki
 */
public class WebUtil {
    private final static Logger logger = Logger.getLogger(WebUtil.class.getName());
    ...
    /**
     * Chekcs if the given email address is valid.
