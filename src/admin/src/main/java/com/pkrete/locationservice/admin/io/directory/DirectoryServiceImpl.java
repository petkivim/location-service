 ...
 *
 * This class offers methods for getting listings of directory contents, and for
 * adding, renaming and deleting directories.
 *
 * @author Petteri Kivimäki
 */
public class DirectoryServiceImpl implements DirectoryService {

    private final static Logger logger = LoggerFactory.getLogger(DirectoryServiceImpl.class.getName());

    /**
     * Returns a list of directories inside the directory pointed by the given
     * base path. Hidden directories are excluded.
     *
    ...
    /**
     * Returns a list of directory names as strings inside the directory pointed
     * by the given base path. Hidden directories are excluded.
     *
     * @param basePath absolute path of the base directory
    ...
    /**
     * Returns a list of files inside the directory pointed by the given base
     * path. Hidden files are excluded.
     *
    ...
    /**
     * Returns a list of file names as strings inside the directory pointed by
     * the given base path. Hidden files are excluded.
     *
     * @param dir absolute path of the directory
    ...
    /**
     * Returns a list of directory entries matching the given filter inside the
     * directory pointed by the given base path.
     *
     * @param basePath absolute path of the base directory
     ...
     * and their contents are deleted before deleting the directory. will be
     * deleted before deleting the directory.
     *
     * @param dir abstract path name
     ...
     * subdirectories don't contain any files that are not present in the
     * ignored files list.
     *
     * @param dir abstract pathname
     * @param ignoredFiles list of files that are ignore - directory is
     * considered empty it it contains only files that are present in this list
