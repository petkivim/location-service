...
/**
 * This class represents a description related to a location object. Location
 * object can have several descriptions, one in each language configured in the
 * system. Each description can be related to only one location at a time.
 *
...
public class Description implements Serializable, Comparable {
    ...
    /**
     * Initializes and constructs a new Description object.
     */
    public Description() {
        this.id = 0;
    }
    ...
    /**
     * Returns the description of the object which this description is related
     * to.
     *
    ...
    /**
     * Changes the value of the description of the object which this description
     * is related to.
     *
