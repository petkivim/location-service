...
/**
 * This class extends {@link SubjectMattersServiceImpl SubjectMattersServiceImpl} 
 * class which implements {@link SubjectMattersService SubjectMattersService} 
 * interface, that defines service layer for SubjectMatters objects.
 * 
 * This class overrides methods that define operations with an 
...
public class SubjectMattersServiceWithExtIndexSupportImpl extends SubjectMattersServiceImpl {
    ...
    private final static Logger logger = Logger.getLogger(SubjectMattersServiceWithExtIndexSupportImpl.class.getName());
    ...
    /**
     * Can be used for updating SubjectMatters to external index.
     * SubjectMatters are not indexed, but they're stored in the index
     * with locations. When subject matter changes, all the locations
     * need to be updated.
     * @param subject SubjectMatter to be updated
     * @return true if and only if all the locations related to the given
     * subject were succesfully updated; otherwise false
     */
    @Override
