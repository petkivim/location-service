 ...
 * The {
 *
 * @LocalAdminUserController LocalAdminUserController} class returns the page
 * that contains the list of all the users belonging to the same Owner with the
 * local admin who accesses the page. LocalAdminUserController returns a model
 * that contains all the objects that are needed in the page that is shown tothe
 * user. LocalAdminUserController implements the Controller interface.
 *
 * @author Petteri Kivimäki
 */
@Controller
@RequestMapping("/ladmuser.htm")
public class LocalAdminUserController {
