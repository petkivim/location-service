...
public class OwnerDocumentBuilder {
    ...
    public static OwnerDocument build(Owner owner) {
        ...
        document.setPreprocessingRedirects(OwnerDocumentBuilder.build((List) owner.getPreprocessingRedirects()));
        document.setNotFoundRedirects(OwnerDocumentBuilder.build((List) owner.getNotFoundRedirects()));
        // Return the object
        return document;
    }
    ...
    public static Owner build(OwnerDocument document) {
        ...
        owner.setPreprocessingRedirects((List) OwnerDocumentBuilder.build(document.getPreprocessingRedirects(), true));
        owner.setNotFoundRedirects((List) OwnerDocumentBuilder.build(document.getNotFoundRedirects(), false));
        // Return the object
        return owner;
    }
     ...
     */
    private static List<String> build(List<CallnoModification> list) {
