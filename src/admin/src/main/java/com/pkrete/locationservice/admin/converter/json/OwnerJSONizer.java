...
public class OwnerJSONizer implements JSONizerService<Owner> {
    ...
    /**
     * Converts a single owner object to JSON string. All the variables of
     * the Owner object are included.
    ...
    /**
     * Converts a single owner object to JSON string. All the variables of
     * the Owner object are included. If logEntry is true, also owner_id
     * is included.
     * @param source Owner object to be converted
    ...
    /**
     * Converts a list of Owner objects to JSON string. Only selected
