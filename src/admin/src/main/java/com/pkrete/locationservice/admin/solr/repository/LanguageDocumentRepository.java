...
public interface LanguageDocumentRepository extends SolrCrudRepository<LanguageDocument, String> {
    ...
    LanguageDocument findByOwnerIdAndLanguageCodeAndDocumentType(Integer ownerId, String languageCode, DocumentType documentType);

    List<LanguageDocument> findByDocumentType(DocumentType documentType);

    List<LanguageDocument> findByOwnerIdAndDocumentType(Integer ownerId, DocumentType documentType, Sort sort);
