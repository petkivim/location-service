...
public class IllustrationsUtil {
    ...
    /**
     * Builds the absolute path of the given image file based on filename, and
     * owner information. However, it's not tested whether the file exists or
     * not.
     *
    ...
    /**
     * Builds the absolute path of the given map file based on filename,
     * language and owner information. However, it's not tested whether the file
     * exists or not.
     *
