 ...
 * The {
 *
 * @IllustrationController IllustrationController} class returns the page that
 * contains the list of all the maps and images in the LocationService or
 * redirects/forwards the user to another page. The function depends on the
 * request parameters. IllustrationController returns a model that contains all
 * the objects that are needed in the page that is shown to the user.
