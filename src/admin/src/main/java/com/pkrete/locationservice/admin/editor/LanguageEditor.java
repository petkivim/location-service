...
/**
 * The {@link LanguageEditor LanguageEditor} converts Language
 * objects expressed as strings to Language objects. The string presentation
 * of a Language object is the object's id number in the database. This
...
public class LanguageEditor extends PropertyEditorSupport {
    ...
    @Override
    /**
     * Converts a string containing an id number of a Language object to
