 ...
 * implements the locations search by the given parameters and returns a list of
...
public class SearcherImpl extends BaseSearcher {
    ...
    private final static Logger logger = LoggerFactory.getLogger(SearcherImpl.class.getName());
     ...
     * returns a list of collections belonging to the library which id equals
     * the searchStr parameter. If level is SHELF, returns a list of shelves
     * belonging to the collection which id equals the searchStr parameter.
     *
