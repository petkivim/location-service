...
/**
 * The {@link MapEditor MapEditor} converts Map objects expressed as strings to
 * Map objects. The string presentation of a Map object is the object's id
 * number in the database. This class is used to convert the values of HTML drop
 * down menus to corresponding objects.
 *
...
public class MapEditor extends PropertyEditorSupport {
    ...
    @Override
    /**
     * Converts a string containing an id number of a Map object to the
