 ...
 * Languages from external search index.
 *
 * @author Petteri Kivimäki
 */
public interface LanguageIndexService {

    List<Language> search(Integer ownerId);

    Language search(Integer ownerId, String languageCode);

    boolean save(Language document);
