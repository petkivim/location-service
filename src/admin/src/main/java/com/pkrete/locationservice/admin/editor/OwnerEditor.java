...
/**
 * The {@link OwnerEditor OwnerEditor} converts Owner
 * objects expressed as strings to Owner objects. The string presentation
 * of an Owner object is the object's id number in the database. This
...
public class OwnerEditor extends PropertyEditorSupport {
    ...
    @Override
    /**
     * Converts a string containing an id number of an Owner object to
