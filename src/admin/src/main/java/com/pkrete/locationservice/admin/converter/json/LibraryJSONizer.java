...
public class LibraryJSONizer extends LocationJSONizer implements JSONizerService<Library> {
    ...
    /**
     * Converts a single Library object to JSON string. All the variables of the
     * Library object are included.
     *
    ...
    /**
     * Converts a single Library object to JSON string. All the variables of the
     * Library object are included. If logEntry is true, also owner_id is
     * included.
     *
     * @param source Library object to be converted
