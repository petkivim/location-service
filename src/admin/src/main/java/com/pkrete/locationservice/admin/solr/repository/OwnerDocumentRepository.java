 ...
 * searching Owners from an external search index. Methods for adding,
...
public interface OwnerDocumentRepository extends SolrCrudRepository<OwnerDocument, String> {
    ...
    public List<OwnerDocument> findByDocumentType(DocumentType documentType, Sort sort);

    public List<OwnerDocument> findByOwnerIdAndDocumentType(Integer locationId, DocumentType documentType);
    
    public List<OwnerDocument> findByOwnerCodeAndDocumentType(String ownerCode, DocumentType documentType);
}
