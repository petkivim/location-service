...
/**
 * The {@link LibraryEditor LibraryEditor} converts Library
 * objects expressed as strings to Library objects. The string presentation
 * of a Library object is the object's id number in the database. This
...
public class LibraryEditor extends PropertyEditorSupport {
    ...
    @Override
    /**
     * Converts a string containing an id number of a Library object to
