...
/**
 * Custom Deserializer for Language objects.
 * 
 * @author Petteri Kivimäki
 */
public class LanguageJSONDeserializer extends JsonDeserializer<Language> {

    @Override
    public Language deserialize(JsonParser jsonParser,
