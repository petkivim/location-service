 ...
 * which implements {@link LanguagesService LanguagesService} interface, 
 * that defines service layer for Language objects.
 * 
...
public class LanguagesServiceWithExtIndexSupportImpl extends LanguagesServiceImpl {
    ...
    private final static Logger logger = Logger.getLogger(LanguagesServiceWithExtIndexSupportImpl.class.getName());
     ...
     * Language was succesfully added, otherwise false.
     * @param language Language to be added
     * @return true if and only if the Language was succesfully added, 
     * otherwise false
     */
    @Override
     ...
     * Language was succesfully updated, otherwise false.
     * @param location Language to be updated
     * @return true if and only if the Language was succesfully updated, 
     * otherwise false
     */
    @Override
     ...
     * Language was succesfully deleted, otherwise false.
     * @param location Language to be deleted
     * @return true if and only if the Language was succesfully deleted, 
     * otherwise false
     */
    @Override
    ...
    /**
     * Returns a list of all the languages that are related to
     * the given owner.
