 ...
 */
public class EditTemplateController implements Controller {

    private UsersService usersService;
    private TemplatesService templatesService;
    private CSSService cssService;
    private JSService jsService;
    private Map libraryTags;
    private Map collectionTags;
    private Map shelfTags;
    private Map notFoundNotAvailableTags;

    public EditTemplateController() {
    }
    ...
    public void setLibraryTags(Map libraryTags) {
        this.libraryTags = libraryTags;
    }

    public void setCollectionTags(Map collectionTags) {
        this.collectionTags = collectionTags;
    }

    public void setShelfTags(Map shelfTags) {
        this.shelfTags = shelfTags;
    }

    public void setNotFoundNotAvailableTags(Map notFoundNotAvailableTags) {
        this.notFoundNotAvailableTags = notFoundNotAvailableTags;
    }
