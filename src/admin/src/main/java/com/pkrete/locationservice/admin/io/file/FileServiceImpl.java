...
/**
 * FileServiceImpl class implements the {@link FileService FileService}
 * interface.
 *
 * This class offers methods for creating, reading, updating, deleting and
 * moving files.
 *
...
public class FileServiceImpl implements FileService {
    ...
    private final static Logger logger = LoggerFactory.getLogger(FileServiceImpl.class.getName());

    /**
     * Creates the file denoted by the abstract pathname and writes the given
     * contents in it. If the file already exists, nothing is done and false is
     * returned.
     *
     * @param path abstract path name
     * @param contents contents of the file
     * @return true if and only if the file doesn't exist and it's successfully
    ...
    /**
     * Updates the contents of file denoted by the abstract pathname. If the
     * file doesn't exist, nothing is done and false is returned.
     *
     * @param path abstract path name
     * @param contents contents of the file
     * @return true if and only if the file exists and it's successfully
     ...
     * If the file doesn't exist it's created, existing file will be
     * overwritten.
     *
     * @param path abstract path name
     * @param contents contents of the file
     * @return true if and only if the file is successfully written; otherwise
     * false
     */
    @Override
     ...
     *
     * @param path abstract path name
     * @return true if and only if the file is successfully deleted; false
     * otherwise
     */
    @Override
