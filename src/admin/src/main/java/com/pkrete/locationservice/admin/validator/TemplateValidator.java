...
/**
 * This class validates Template objects. This class defines the obligatory
 * variables and returns an error message associated with the variable when the
 * value of the variable is not valid.
 *
