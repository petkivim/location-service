 ...
 * objects expressed as strings to LibraryCollection objects. The string presentation
 * of a LibraryCollection object is the object's id number in the database. This
...
public class CollectionEditor extends PropertyEditorSupport {
    ...
    @Override
    /**
     * Converts a string containing an id number of a LibraryCollection object to
