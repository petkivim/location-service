...
/**
 * This interface defines service layer for statistics. All the classes
...
public interface StatisticsService {
    ...
    StatisticsSearchResult getStatistics(String owner, StatisticsGroup group, SearchEventType type, String from, String to, String sortOrder);
}
