...
/**
 * The {@link SubjectMatterValidator SubjectMatterValidator} class validates the
 * values inserted via addSubjectMatter and editSubjectMatter forms. This class
 * defines the obligatory fields and returns an error message associated with
 * the field when the value of the field is not valid.
 *
