...
/**
 * This class extends {@link OwnersServiceImpl OwnersServiceImpl} class
 * which implements {@link OwnersService OwnersService} interface, 
 * that defines service layer for Owner objects.
 * 
...
public class OwnersServiceWithExtIndexSupportImpl extends OwnersServiceImpl {
    ...
    private final static Logger logger = Logger.getLogger(OwnersServiceWithExtIndexSupportImpl.class.getName());
    ...
    /**
     * Adds the Owner to external index. Returns true if and only if the 
     * Owner was succesfully added, otherwise false.
     * @param owner Owner to be added
     * @return true if and only if the Owner was succesfully added, 
     * otherwise false
     */
    @Override
     ...
     * Owner was succesfully updated, otherwise false.
     * @param owner Owner to be updated
     * @param hasChanged boolean value that tells if the owner code has
     * changed
     * @return true if and only if the Owner was succesfully updated, 
     * otherwise false
     */
    @Override
     ...
     * Owner was succesfully deleted, otherwise false.
     * @param owner Owner to be deleted
     * @return true if and only if the Owner was succesfully deleted, 
     * otherwise false
     */
    @Override
    ...
    /**
     * Recreates the search index. First all the current entries are deleted
