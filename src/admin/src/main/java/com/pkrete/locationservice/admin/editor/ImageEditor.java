...
/**
 * The {@link ImageEditor ImageEditor} converts Image
 * objects expressed as strings to Image objects. The string presentation
 * of an Image object is the object's id number in the database. This
...
public class ImageEditor extends PropertyEditorSupport {
    ...
    @Override
    /**
     * Converts a string containing an id number of an Image object to
