...
public class UsersUtil {
    ...
    private final static Logger logger = LoggerFactory.getLogger(UsersUtil.class.getName());

    /**
     * Returns the User object that is stored in the session related to the
     * given HTTP request. If the user cannot be found from the session it's
     * fetched from the DB by using the given service object,
     *
