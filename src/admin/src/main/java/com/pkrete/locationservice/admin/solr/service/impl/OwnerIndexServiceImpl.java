...
public class OwnerIndexServiceImpl implements OwnerIndexService {
    ...
    /**
     * Adds or updates the given Owner object to the search index. Returns 
     * true if and only if the Owner was succesfully added or updated; 
     * otherwise false.
     * @param owner Owner to be added
     * @return true if and only if the Owner was succesfully added or updated; 
     * otherwise false
     */
    ...
    /**
     * Deletes the Owner with the given id from the search index. Returns
     * true if and only if the Owner was succesfully deleted; otherwise
     * false
