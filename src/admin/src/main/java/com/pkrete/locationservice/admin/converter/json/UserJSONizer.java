...
/**
 * This class converts Userobjects to JSON.
 * 
...
public class UserJSONizer implements JSONizerService<User> {
    ...
    /**
     * Converts a single User object to JSON string. All the variables of
     * the User object are included.
    ...
    /**
     * Converts a list of User objects to JSON string. Only selected
