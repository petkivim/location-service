...
/**
 * The {@LanguageController LanguageController} class returns the page that
 * contains the list of all the languages in the LocationService and offers
 * the necessary functionality for adding, modifying and deleteting them.
 * The function depends on the request parameters. LanguageController returns
 * a model that contains all the objects that are needed in the page that
 * is shown to the user. IllustrationController implements the
