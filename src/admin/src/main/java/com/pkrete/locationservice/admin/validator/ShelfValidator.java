...
/**
 * The {@link ShelfValidator ShelfValidator} class validates Shelf objects. 
 * This class defines the obligatory fields and returns an error message 
 * associated with the field when the value of the field is not valid.
 *
