...
/**
 * LocationService class implements the Service interface and implements all the
 * methods defined in the interface. The class offers functionality that other
 * parts of the program use when they need to access the database. Concrete
 * database operations are executed through {@link Dao Dao} interface. Single
 * service method can include one or more database operations defined in the Dao
 * interface.
 *
...
public class LocationsService implements Service {
     ...
     * number and that related to the given owner.
     *
     ...
     */
    /**
     * Returns all the locations which id is in the given lists. All the lazy
     * relationships are loaded. If children is true, all the collections and
     * shelves belonging to the libraries are loaded too.
     *
