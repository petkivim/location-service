 ...
 * that the user is authorized to access the Exporter servlet.
 *
 * @author Petteri Kivimäki
 */
public class ExporterAuthorizationFilter implements Filter {

    private static final Logger logger = LoggerFactory.getLogger(ExporterAuthorizationFilter.class.getName());
     ...
     * Requestor is authorized if the IP address matches an IP address defined
