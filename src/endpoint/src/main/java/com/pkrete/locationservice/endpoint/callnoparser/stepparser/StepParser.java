 ...
 * 
 * StepParser follows the Chain of Responsability design pattern which means 
 * that it delegates the task to the next object in the chain if it's not able 
 * to complete the given task. All the subclasses must implement the 
 * abstract <i>parse</i> method defined in the CallNoParser base class.
 * 
...
public abstract class StepParser extends CallNoParser {
    ...
    /**
     * The maximum amount of words in the location information that the class in question can handle.
     */
    protected int limit;
    /**
    ...
    /**
     * Contructs and initializes a StepParser object with the given generator 
     * object and limit
    ...
    /**
     * Contructs and initializes a StepParser object with the given 
     * generator object and limit
     * @param generator the generator object that generates the html page 
     * returned to the user
     * @param limit the maximum amount of words in the call number that the 
     * class can handle
     * @param previous CallNoParser object before this object in processiong 
     * queue
     */
