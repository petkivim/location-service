 ...
 * define the layout of the UI. All the classes implementing this interface must
 * implement all the methods defined in this interface. Template files can
 * contain markup codes that must be replaced with the corresponding
 * information. Classes implementing this interface can freely define the markup
 * they support.
 *
...
public interface TemplateParser {
     ...
     */
    String parse(String line, String lang, Shelf shelf, String callno, Loader loader);
     ...
     * @return parsed string
     */
    String parse(String line, String lang, LibraryCollection collection, String callno, Loader loader);
     ...
     * @return parsed string
     */
    String parse(String line, String lang, Library library, String callno, Loader loader);
     ...
     * @return parsed string
     */
    String parse(String line, String lang, String status, String callno, Loader loader, String owner);
}
