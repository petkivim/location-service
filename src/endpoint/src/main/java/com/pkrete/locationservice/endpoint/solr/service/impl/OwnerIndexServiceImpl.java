...
/**
 * This service class offers methods for searching Owners from external search
 * index.
 *
...
public class OwnerIndexServiceImpl implements OwnerIndexService {
    ...
    /**
     * Returns a list of active PreprocessingRedirects related to the given
     * owner.
     *
    ...
    /**
     * Returns a list of active NotFoundRedirects related to the given owner.
     *
     * @param ownerCode owner code of the redirects' owner
     * @return list of active redirects
     */
