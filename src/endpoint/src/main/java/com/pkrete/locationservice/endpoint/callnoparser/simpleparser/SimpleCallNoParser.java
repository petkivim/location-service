...
/**
 * The <code>SimpleCallNoParser</code> class extends the
 * {@link CallNoParser CallNoParser} class.
 *
 * The SimpleCallNoParser class offers the functionality for parsing the
...
public class SimpleCallNoParser extends CallNoParser {
    ...
    /**
     * Constructs and initializes a SimpleCallNoParser object.
     */
    ...
    /**
     * Constructs and initializes a SimpleCallNoParser object with the given
     * generator
     *
