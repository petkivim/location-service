...
/**
 * The <code>StepParserLevel9</code> class extends the {@link StepParser StepParser} class.
 *
 * The StepParserLevel9 class defines the functionality for parsing the location information
 * from the given string and it has no limitations regarding to the size of the string. However, only the first nine
...
public class StepParserLevel9 extends StepParser {
    ...
    /**
     * Contructs and initializes a StepParserLevel9 object with the given generator
