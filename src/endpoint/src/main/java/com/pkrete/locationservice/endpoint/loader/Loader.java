...
/**
 * An interface that defines the methods for loading the template files that are
 * used for generating the HTML page that is returned to user. All the classes
 * implementing this interface must implement all the methods defined in this
 * interface.
 *
...
public interface Loader {
     ...
     */
    String loadTemplate(String lang, Shelf shelf, String callno);
     ...
     * @return the context of the template file
     */
    String loadTemplate(String lang, LibraryCollection collection, String callno);
     ...
     * @return the context of the template file
     */
    String loadTemplate(String lang, Library library, String callno);

    /**
     * Loads the template that is shown to the user when the location doesn't
     ...
     * @return the context of the template file
     */
    String loadTemplateNotFound(String lang, String callno, String owner);

    /**
     * Loads the template that is shown to the user when the located item is not
     * available.
     *
     * @param lang the language of the UI
     * @param callno the call number received from the UI
     ...
     * @return the context of the template file
     */
    String loadTemplateNotAvailable(String lang, String callno, String owner);

    /**
     * Loads the template of the given name, language and status. This method is
     * used when the given call number doesn't match to any Location object in
     * the database or the given item is not available.
     *
     ...
     */
    String loadTemplate(String lang, String template, String status, String callno, String owner);
     ...
     * @return contents of the template
     */
    String loadTemplate(String lang, Shelf shelf, String callno, String template);
     ...
     * @return contents of the template
     */
    String loadTemplate(String lang, LibraryCollection collection, String callno, String template);
     ...
     * @return contents of the template
     */
    String loadTemplate(String lang, Library library, String callno, String template);
     ...
     */
    String getTemplateOtherPath(String template, String lang, String owner);
}
