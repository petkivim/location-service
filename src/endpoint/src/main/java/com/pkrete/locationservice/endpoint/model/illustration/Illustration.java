...
public abstract class Illustration {
    ...
    private int id;
    /**
     * A string that defines the location of the image that the object
     * represents.
     */
    private String path;
    ...
    /**
     * Returns the path of the image that the object represents. The path is a
     * directory path if the iamge is on the same server. Otherwise the path is
     * an URL address.
     *
