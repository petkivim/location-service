...
/**
 * This class defines constants that are used in many different classes through
 * the application. In some cases constants are used as default values and can
 * be overridden in individual beans.
 *
