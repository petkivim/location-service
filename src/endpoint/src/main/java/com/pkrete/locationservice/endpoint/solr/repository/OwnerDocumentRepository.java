...
/**
 * This interfaces defines methods for searching Owners from an external 
 * search index.
 * 
...
public interface OwnerDocumentRepository extends SolrCrudRepository<OwnerDocument, String> {
    public OwnerDocument findByOwnerCodeAndDocumentType(String ownerCode, DocumentType documentType);
}
