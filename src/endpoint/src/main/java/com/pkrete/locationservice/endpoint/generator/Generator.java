...
public interface Generator {
     ...
     */
    String generateOutput(Library library, String lang, String callno);
     ...
     * @return output that is returned to the user
     */
    String generateOutput(LibraryCollection collection, String lang, String callno);
     ...
     * @return output that is returned to the user
     */
    String generateOutput(Shelf shelf, String lang, String callno);

    /**
     * Generates output that is returned to the user when the given location
     ...
     * @return output that is returned to the user
     */
    String generateOutputNotFound(String lang, String callno, String owner);

    /**
     * Generates the output that is returned to the user when the located item
     * is not available.
     *
     * @param lang the language of the UI
     * @param callno the call number that was received from the UI
     ...
     * @return output that is returned to the user
     */
    String generateOutputNotAvailable(String lang, String callno, String owner);
     ...
     */
    String generateBatchOutput(List locations, List<Language> languages, boolean children);
     ...
     */
    String generateError(String errorCode, String errorMsg);
}
