 ...
 * 
 * Implements all the methods of the {@link Generator Generator} interface 
 * as empty. This class can be used as a base class for classes implementing 
 * only one or some methods of the interface.
 * 
...
public abstract class EmptyGenerator implements Generator {
    ...
    /**
     * Generates the html page that is returned to the user when the located item is not available.
     * @param lang the language of the UI
     * @param callno the call number that was received from the UI
     * @param owner owner code of the library
     * @return an empty string
