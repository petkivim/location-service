...
/**
 * This abstract class defines an abstract search method that's used for
 * searching locations matching the given parameters. Th
 *
...
public abstract class Search {
    ...
    /**
     * Finds all the expressions of the given pattern from the given string and
     * escapes them.
     *
     ...
     * parameter, and the position information is added to the search string.
     *
